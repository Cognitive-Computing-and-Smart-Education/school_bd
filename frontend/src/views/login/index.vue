      ...
      <div class="login-content-box">
        ...
        <el-card class="login-card-box">
          <div class="flex-box login-tabs-box">
            <div class="login-tabs-text finger" @click="tabsChange(1)"
                 :class="[loginActive === 1 ? 'login-tabs-active' : '']">手机登录
            </div>
            <div class="login-tabs-xian"></div>
            <div class="login-tabs-text finger" @click="tabsChange(2)"
                 :class="[loginActive === 2 ? 'login-tabs-active' : '']">账号登录
            </div>
          </div>
          <div class="login-text-box">
            ...
            <div class="login-input-box">
              <div v-if="loginActive !== 3">
                <div v-if="loginActive === 1">
                  <div class="loginBox"><img src="../../assets/img/user.png" class="icon"/>
                    <el-input v-model="phoneNo" placeholder="请输入手机号" clearable class="login-input"></el-input>
                  </div>
                  <div class="loginBox"><img src="../../assets/img/password.png" class="icon"/>
                    <el-input placeholder="请输入验证码" v-model="verificationCodeNo" clearable class="login-input">
                      <template slot="append">
                        <div class="login-verification-code finger" v-if="!verificationCodeStart"
                             @click="verificationCodeBtn">{{ verificationCodeText }}
                        </div>
                        <div class="login-verification-code finger" v-if="verificationCodeStart">{{
                            verificationCode
                          }}s
              ...
              <div v-if="loginActive === 3">
                ...
                <div class="login-ewm-box login-noEwm-box" v-if="!ewmShow">
                  <div style="width: 100%;margin-bottom: -50px;text-align: center;color: #fff;font-size: 15px">二维码已失效
                  </div>
            ...
            <div class="login-arther">
              ...
              <div class="login-arther-content flex-box align-items-center justify-content-spaceBetween">
                <div class="login-arther-wx flex-box align-items-center finger" v-if="loginActive !== 3"
                     @click="ewmLogin">
